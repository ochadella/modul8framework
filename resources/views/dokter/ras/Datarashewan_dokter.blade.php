...
<head>
  <meta charset="UTF-8">
  <title>Data Ras Hewan | Dokter RSHP</title>
  ...
  <style>
    ...
    .container{background:#fff;border-radius:16px;padding:30px;margin-top:50px;box-shadow:0 8px 20px rgba(0,0,0,0.2);max-width:900px;}
...
<body>
  ...
  <div class="container">
    ...
    <?php else: ?>
      <p class="text-center text-muted">Belum ada data ras hewan.</p>
    <?php endif; ?>
