...
<div class="navbar">
    ...
    <div class="nav-center">
        <div class="nav-search">
            ...
            <input type="text" placeholder="Cari menu atau data kategori klinis...">
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('admin.kategoriklinis.data') }}" class="sidebar-link active">
    ...
    <div class="main-area">
        ...
        <div class="page-header">
            <i class="bi bi-card-checklist page-header-icon"></i>
            <h1>Data Kategori Klinis</h1>
            <p>Kelola data kategori klinis untuk tindakan medis.</p>
        </div>

        <!-- KONTEN UTAMA -->
        <div class="container">

            <a href="#" class="btn-add" onclick="document.getElementById('modalTambah').style.display='flex'">+ Tambah Kategori Klinis</a>
            ...
            <table>
                ...
                <tbody>
                    ...
                    @forelse($rows as $r)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $r['nama_kategori_klinis'] ?? '-' }}</td>
                            <td>{{ $r['deskripsi'] ?? '-' }}</td>

                            <td>
                                <div class="action-icons">
                                    <a href="{{ route('admin.kategoriklinis.edit', $r['idkategori_klinis']) }}" class="icon-btn">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>

                                    <a href="{{ route('admin.kategoriklinis.delete', $r['idkategori_klinis']) }}"
                                       onclick="return confirm('Yakin hapus kategori klinis ini?')" class="icon-btn">
...
<div id="modalTambah">
    <div class="modal-box">
        ...
        <h2 style="text-align:center;color:#102f76;margin-top:0">Tambah Kategori Klinis</h2>

        <form method="POST" action="{{ route('admin.kategoriklinis.store') }}">
            @csrf
            ...
            <div style="display:flex;justify-content:flex-end;gap:10px;margin-top:20px;">
                <button type="button"
                        ...
                        style="padding:10px 16px;background:#6c757d;border:none;color:#fff;border-radius:8px;">
                    Batal
                </button>

                <button type="submit"
                        style="padding:10px 16px;background:#f9a01b;border:none;color:#102f76;font-weight:700;border-radius:8px;">
                    Simpan
                </button>
            </div>
        </form>
