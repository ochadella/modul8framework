...
<head>
    ...
    <style>
        ...
        /* ---------- SIDEBAR (SAMA DENGAN DATA KATEGORI) ---------- */
        .sidebar {
            width: 215px;
            border-radius: 24px;
        ...
        /* ================= MODAL (SAMA STYLE DATA KATEGORI) ================= */
        .modal {
            display: none;
            position: fixed;
            inset: 0;
...
<div class="layout">
    ...
    <!-- SIDEBAR (DISESUAIKAN DENGAN DATA KATEGORI, ACTIVE = KATEGORI KLINIS) -->
    <aside class="sidebar">
    ...
    <div class="main-area">
        ...
        <div class="container">
            ...
            <a href="#"
               class="btn-add"
               onclick="document.getElementById('modalTambah').style.display='flex'">+ Tambah Kategori Klinis</a>
