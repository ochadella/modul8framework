...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('admin.role.manajemen') }}"
            class="sidebar-link">
            ...
            <a href="{{ route('dokter.jenis.data') }}"
            class="sidebar-link">
                <i class="bi bi-ui-checks-grid"></i>
                <span>Jenis Hewan</span>
            </a>

            <a href="{{ route('dokter.ras.data') }}"
            class="sidebar-link">
                <i class="bi bi-diagram-3-fill"></i>
                <span>Ras Hewan</span>
            </a>

            <a href="{{ route('resepsionis.pemilik') }}"
            class="sidebar-link">
            ...
            <a href="{{ route('resepsionis.pet') }}"
            class="sidebar-link active">
                <i class="bi bi-bag-heart-fill"></i>
                <span>Data Pet</span>
            </a>

            <a href="{{ route('admin.kategori.data') }}"
            class="sidebar-link">
                <i class="bi bi-tags-fill"></i>
                <span>Kategori</span>
            </a>

            <a href="{{ route('admin.kategoriklinis.data') }}"
            class="sidebar-link">
                <i class="bi bi-card-checklist"></i>
                <span>Kategori Klinis</span>
            </a>

            <a href="{{ route('admin.kodetindakan.data') }}"
            class="sidebar-link">
